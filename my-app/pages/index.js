      ...
      toast.success(
        <div className="flex flex-col gap-2">
          <p className="text-green-800">
            {" "}
            Sucessfully minted Crypto Dev Tokens!
          </p>
        </div>,
        {
          duration: 10000,
          ...
          {walletConnected ? (
            <div>
              <div className={styles.description}>
                ...
                You have minted <strong>{utils.formatEther(balanceOfCryptoDevTokens)}</strong> Crypto
                Dev Tokens
              </div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
                Overall <strong>{utils.formatEther(tokensMinted)}</strong> of 10000 have been minted!!!
              </div>
              {renderButton()}
            </div>
          ) : (
